      ...
      <div className='grid grid-cols-1 md:grid-cols-[240px_1fr] gap-8 items-start my-12 md:my-20 max-w-5xl mx-auto'>
        ...
        <div className='flex min-w-0 flex-col gap-8'>
          <div className='text-gray-700 dark:text-gray-200'>
            ...
            이후 IT로 방향을 전환해, 2025년 8월부터 포트폴리오 사이트를 직접 설계·배포했고, 9월부터는 현직 실무자가 부여한 과제를 매주 직접 해결하며 학습해오고 있습니다. 학습 과정은 기술 블로그에 꾸준히 기록해오고 있습니다. 지금은 네트워크·보안 기초와 악성코드 분석 실습(정적·동적·네트워크 분석)을 병행하며 보안 직무 진입을 준비하고 있습니다.
            </p>
          </div>
