            ...
            {infoList.map(({ icon: Icon, title, description }, index) => (
              ...
              >
                <Icon
                  ...
                  aria-hidden
                />
                <h3 className='mb-2 font-semibold text-gray-800 dark:text-white break-keep'>{title}</h3>
                <p className='text-sm text-gray-600 dark:text-white/80 break-keep'>{description}</p>
              </li>
            ))}
          </ul>
        </div>
