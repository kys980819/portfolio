...
const Header = () => {
  return (
    <div id='top' className='w-11/12 max-w-3xl text-center mx-auto min-h-screen flex flex-col items-center justify-center gap-4 pt-16'>
      <div className='rounded-lg border border-line bg-panel p-1.5 dark:border-darkBorder dark:bg-darkSurface'>
       <Image src={assets.profile_kys_img} alt='김윤성 프로필 사진' className='rounded-md w-32'/>
      </div>
      ...
      <p className='max-w-2xl mx-auto text-pretty break-keep text-inkMuted dark:text-darkMuted'>
